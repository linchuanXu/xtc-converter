...
*/
    ...
    // Optional hint for callers to classify why an image is being drawn.
    // 0 means regular content image; non-zero values are backend-specific.
    virtual void setImageDrawHint(int hint) { CR_UNUSED(hint); }
